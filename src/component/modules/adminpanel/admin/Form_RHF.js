...
const Form = ({ title, actions, formComps, initialValues, postdata, formValidationSchema, submitdata, actionlabel, resetTrx, params }) => {
    ...
    if (actions) {
        ...
        switch (actions) {
            ...
            case Appresources.BUTTON_LABEL.LABEL_SAVE:
                dispatch(createData(params, submiting))

                break;
            case Appresources.BUTTON_LABEL.LABEL_UPDATE:
                dispatch(updateData(params, submiting))
                break;
            default:
                break;
