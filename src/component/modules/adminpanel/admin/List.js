...
import { fetchDatas, deleteData, createData, updateData } from './FormAction'
import '../../../Public/CSS/App.css'
import { ActionHelpers, getTitle, getColumn, LovDataSelected, PrepareEditData, QueryData, QueryReducerID, changeReducer, QuerySelectedData, getRowData } from "../../../../utils/FormComponentsHelpler"

const List = ({ data, crudActions, selectedData, reducerid, params }) => {
    ...
    const rowClickHandler = async (action, row) => {
        ...
        switch (action) {
            ...
            case DELETE:
                ...
                let message = `Kode Data : ${row.original.tablecomponent} Akan Dihapus`
    ...
    if (crudActions) {
        ...
        switch (crudActions) {
            ...
            case Appresources.BUTTON_LABEL.LABEL_DELETE:
                dispatch(
                    deleteData(params, selectedData, (v) => {
...
const MapStateToProps = state => {
    ...
    return {
        ...
        params: Object.values(state)[0]['activeRoute']
    }
}
