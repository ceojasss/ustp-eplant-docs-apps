...
import { errorResponse, insertResponse, insertResponseGrid, updateResponse } from '../../../../redux/actions'
import { Appresources } from '../../../templates/ApplicationResources'

const ROUTES = '/hr/Trx/medicalinternal'
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    console.log('done fetch medicalinternal')
...
export const fetchDatadetail = (params,callback) => async dispatch => {
    console.log('run fetch medicalinternaldetail')

    const response = await eplant.get(`${ROUTES}/detail?docnum=${params}`)
    

    console.log('done fetch medicalinternaldetail')
