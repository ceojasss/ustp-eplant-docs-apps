...
const ROUTES = '/hr/Trx/medicalexternal'
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    console.log('done fetch medicalexternal')
...
export const fetchDatadetail = (params,callback) => async dispatch => {
    console.log('run fetch medicalexternaldetail')

    const response = await eplant.get(`${ROUTES}/detail?docnum=${params}`)
    

    console.log('done fetch medicalexternaldetail')
