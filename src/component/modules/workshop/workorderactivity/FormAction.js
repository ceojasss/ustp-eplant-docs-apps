...
const ROUTES = '/workshop/Trx/workorderactivity'
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    ...
    // // console.log(params)
    const response = await eplant.get(`${ROUTES}/detail?workorderno=${params[0]}&tdate=${params[1]}&period=${format(params[2], 'mm/yyyy')}`)
