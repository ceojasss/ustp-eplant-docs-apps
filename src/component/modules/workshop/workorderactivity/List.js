/*=============================================================================
 ...
 |          
 |  Description:  List Transaksi Purchase Request
 |
 *===========================================================================*/
    ...
    const rowClickHandler = async (action, row) => {
        ...
        switch (action) {
            case UPDATE:
                ...
                if (!isDataExist(row.original.workorderno))
                    await dispatch(fetchDatadetail(getRowDoubleData(row),
                        // async () => {
                ...
                navigate(`./edit/${encodeURIComponent(row.original.workorderno)}`)
                break;
            case DELETE:
