...
import { ERROR_MODAL_STATE, EXCEPTION_ERROR, FETCH_DATAS, FETCH_LISTDATA, FETCH_LISTDATADETAIL, MODAL_STATE, RESET_DETAIL_DATA } from '../../../../redux/actions/types'
...
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    // // console.log('done fetch setuppurchaseitem')
...
export const fetchDatadetail = (params) => async dispatch => {
    ...
    const response = await eplant.get(`${ROUTES}/detail?workorder=${params}`)
