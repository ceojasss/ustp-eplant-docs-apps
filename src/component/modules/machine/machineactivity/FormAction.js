...
const ROUTES = '/machine/Trx/machineactivity'
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    ...
    const response = await eplant.get(`${ROUTES}/detail?machinecode=${(_.isUndefined(params[0]) ? '' : params[0])}&period=${format(params[1], 'mm/yyyy')}`)
