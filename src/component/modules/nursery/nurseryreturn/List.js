/*=============================================================================
 ...
 |          
 |  Description:  List Nursery Return
 |
 *===========================================================================*/
        ...
        switch (action) {
            case UPDATE:
                ...
                if (!isDataExist(row.original.returnnotenumber))
                    await dispatch(fetchDatadetail(row.original.returncode,
                        // async () => {
                ...
                await prepareEditDataMasterDetail(row)
                navigate(`./edit/${encodeURIComponent(row.original.returncode)}`)
                break;
            case DELETE:
                // * set custom delete message     
                dispatch(DialogConfirmation(DELETE, `Kode Data : ${row.original.returncode} Akan Dihapus`, row))
                break;
            default:
                break;
        }
