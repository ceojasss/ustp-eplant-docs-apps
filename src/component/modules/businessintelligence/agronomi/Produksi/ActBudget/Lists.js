...
const Lists = ({ data, p_month, p_year, p_site, p_intiplasma, fetchactbudgetmap, title = 'Act vs Budget' }) => {
  ...
  console.log('act vs budget  list :', data);
  ...
  console.log('fetch act budget map', fetchactbudgetmap)
  return (
        ...
        <Grid.Column>
          ...
          >
            ...
            {fetchactbudgetmap && fetchactbudgetmap.features
              ? fetchactbudgetmap.features.map((state) => {
...
const mapStateToProps = (state) => {
  ...
  return {
    data: state.dashboard.fetchactbudget,
    fetchactbudgetmap: state.dashboard.fetchactbudgetmap
  };
};
