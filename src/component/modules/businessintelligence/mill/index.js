...
import { BIDatePickerHandler, BISitePickerHandler } from "../../../../utils/BIHelper";
import BIDatePicker from "../../../templates/main_container/BIDatePicker";
import BIMonthPicker from "../../../templates/main_container/BIMonthPicker";
import BIYearPicker from "../../../templates/main_container/BIYearPicker";


const List = ({ site,date }) => {
  ...
  // const [site, setSite] = useState(site["0"].value);
        ...
        <Tab.Pane className="container" /*style={{backgroundColor:'#A9A9A9'}}*/>
          <Grid columns={4}>
            <Grid.Row>
              <Grid.Column>
                <label>Tahun:</label>
                 <BIYearPicker pickedDateAction={BIDatePickerHandler( date )}/>
              </Grid.Column>
              <Grid.Column>
                <label>Site:</label>
        ...
        <Tab.Pane className="container" /*style={{backgroundColor:'#A9A9A9'}}*/>
          <Grid>
            <Grid.Row>
              <Grid.Column>
                <label>Periode:</label>
                <BIMonthPicker  pickedDateAction={BIDatePickerHandler( date )}/>
              </Grid.Column>
            </Grid.Row>
          </Grid>
          <TableMillRph
