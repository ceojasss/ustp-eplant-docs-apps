...
const Lists = ({ data,p_month, p_year, title ='This Month'}) => {
  ...
  useEffect(() => {
    if (data && data.component) {
      const filteredColumns = filteringTableMill(data.component, 'componentthismonth');
...
const mapStateToProps = (state) => {
  // console.log(state)
  return {
    data: state.businessintelligence.fetchthismonth,
  };
};
