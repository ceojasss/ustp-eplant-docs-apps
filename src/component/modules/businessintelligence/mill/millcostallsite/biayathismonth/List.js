...
const Lists = ({ data,p_period, p_year, title ='Biaya This Month'}) => {
  ...
  useEffect(() => {
    if (data && data.component) {
      const filteredColumns = filteringTableMill(data.component, 'componentbiayathismonth');
...
const mapStateToProps = (state) => {
  // console.log(state)
  return {
    data: state.businessintelligence.fetchbiayathismonth,
  };
};
