...
const Lists = ({  data, p_year, p_site, title ='TBS Olah : '+ p_site  }) => {
  ...
  useEffect(() => {
    if (data && data.component) {
      const filteredColumns = filteringTableMill(data.component, 'componenttabtbsolah');
      setColumns(filteredColumns);
    }
  }, [data]);

  console.log("Table Tbs Olah", data);
...
const mapStateToProps = (state) => {
  // console.log(state)
  return {
    data: state.businessintelligence.fetchtbsolah,
  };
};
