...
const Lists = ({  data, p_year, p_site, title='Palm Prod (TON): ' + p_site   }) => {
  ...
  useEffect(() => {
    if (data && data.component) {
      const filteredColumns = filteringTableMill(data.component,'componenttabpalmprod');
...
const mapStateToProps = (state) => {
  // console.log(state)
  return {
    data: state.businessintelligence.fetchpalmprod,
  };
};
