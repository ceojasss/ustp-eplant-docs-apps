...
import {FETCH_TABCOSTTBSOLAH,RESET_BI_DATA, SET_LOADING_STATUS} from "../../../../../../redux/actions/types";

const ROUTES = "/bi/mill/costtbsolah";
...
export const fetchData = (p_year,p_site) => async (dispatch) => {
  ...
  dispatch({ type: FETCH_TABCOSTTBSOLAH, payload: response.data });
}