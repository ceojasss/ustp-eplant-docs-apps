...
const Lists = ({  data, p_year, p_site, title ='Cost TBS Olah : '+ p_site  }) => {
  ...
  useEffect(() => {
    if (data && data.component) {
      const filteredColumns = filteringTableMill(data.component, 'componenttabcosttbsolah');
...
const mapStateToProps = (state) => {
  console.log(state)
  return {
    data: state.businessintelligence.fetchcosttbsolah,
  };
};
