...
import {FETCH_COSTPALMPROD,RESET_BI_DATA, SET_LOADING_STATUS} from "../../../../../../redux/actions/types";

const ROUTES = "/bi/mill/costpalmprod";
...
export const fetchData = (p_year,p_site) => async (dispatch) => {
  ...
  dispatch({ type: FETCH_COSTPALMPROD, payload: response.data });
}