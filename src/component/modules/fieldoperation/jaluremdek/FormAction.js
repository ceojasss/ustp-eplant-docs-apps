...
import { parseStringToDate } from '../../../../utils/FormComponentsHelpler'



const ROUTES = '/fieldoperation/setup/jaluremdek'
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    ...
    const response = await eplant.get(`${ROUTES}/detail?blockid=${(_.isUndefined(params[0]) ? '' : params[0])}`)
