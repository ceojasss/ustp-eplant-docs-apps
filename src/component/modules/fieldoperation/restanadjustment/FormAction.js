...
const ROUTES = '/fieldoperation/Trx/restanadjustment'
...
export const fetchDatadetail = (params) => async dispatch => {
    ...
    const response = await eplant.get(`${ROUTES}/detail?estate=${params[0]}&divisi=${params[1]}&period=${format(params[2], 'mm/yyyy')}`)
