...
import { setLoadingModalBtn } from '../../../../redux/actions'
import { ERROR_MODAL_STATE, FETCH_BANKS, FETCH_DATAS, MODAL_STATE } from '../../../../redux/actions/types'
import { Appresources } from '../../../templates/ApplicationResources'


const ROUTES = '/fieldoperation/Trx/bbcpercentage'
export const fetchDatas = () => async dispatch => {
    console.log('run fetch bbcpercentage')

    const response = await eplant.get(ROUTES)

    console.log('done fetch bbcpercentage')
