...
const ROUTES = '/fieldoperation/Trx/lossespanen'
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    console.log('done fetch lossespanen')
...
export const fetchDatadetail = (params) => async dispatch => {
    console.log('run fetch lossespanendetail')
    ...
    console.log('done fetch lossespanendetail')
