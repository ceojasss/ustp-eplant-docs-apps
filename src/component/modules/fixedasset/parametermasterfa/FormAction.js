...
const ROUTES = '/fixedasset/Setup/parameterfixedasset'
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    console.log('done fetch parametermaster')
...
export const fetchDatadetail = (params,callback) => async dispatch => {
    console.log('run fetch parametermasterdetail')

    const response = await eplant.get(`${ROUTES}/detail?parametercode=${params}`)

    console.log('done fetch parametermasterdetail')
