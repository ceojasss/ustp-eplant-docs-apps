...
const ROUTES = '/costbook/Setup/commodityprice'
...
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    console.log('done fetch commodityprice')
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    console.log('run fetch commoditypricedetail')

    const response = await eplant.get(`${ROUTES}/detail?productcode=${params}`)

    console.log('done fetch commoditypricedetail')
