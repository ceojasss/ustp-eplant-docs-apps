...
import RenderTable from "../../../templates/TableNoAction"
...
import { ActionHelpers, getTitle, getColumn, LovDataSelected, PrepareEditData, QueryData, QueryReducerID, QuerySelectedData, getRowData, changeReducer, IsInsert } from "../../../../utils/FormComponentsHelpler"
...
const MapStateToProps = state => {
   // console.log('state : ',state.auth.menu.user);
    return {
