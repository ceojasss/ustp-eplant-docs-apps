...
const MapStateToProps = state => {
    console.log('date ', parseMillSectoString(state.auth.tableDynamicControl.dateperiode))

    console.log('date now', parseMillSectoString(state.auth.tableDynamicControl.dateperiodenow))
