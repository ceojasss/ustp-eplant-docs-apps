...
import { ActionHelpers, getRowData, getColumn, getTitle, LovDataSelected, PrepareEditData, QueryData, QueryReducerID, QuerySelectedData, changeReducer, IsInsert } from "../../../../utils/FormComponentsHelpler"
...
/*=============================================================================
 ...
 |                - 
 |          
 |  Description:  List Data For Master Bank Data
 |                               
 |                
 |                          
 |                          
...
const SetupBankList = ({ data, crudActions, selectedData, reducerid }) => {
...
export default
    requireAuth(connect(MapStateToProps, { fetchDatas })(SetupBankList))
