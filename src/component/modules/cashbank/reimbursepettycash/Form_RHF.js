...
const Forms = ({ title, periode, units, actions, formComp, formComps, initialValues, postdata, formValidationSchema, submitdata, actionlabel, resetTrx, urlpreview }) => {
    ...
    const ClickHandler1 = () => {
        ...
        const vouchercode = encodeURIComponent(methods.getValues('vouchercode'))
        ...
        const urls = `${ROUTES}/link?vouchercode=${vouchercode}`

        dispatch(ShowDataLinkedHeader(PC, urls, 'vouchercode'))
    }
