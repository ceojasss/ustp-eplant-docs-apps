...
export const ROUTES = '/cashbank/Trx/reimbursepettycash'
...
export const fetchDatadetail = (params) => async dispatch => {
    console.log('run fetch purchaseorderdetail' + params)

    const response = await eplant.get(`${ROUTES}/detail?vouchercode=${(_.isUndefined(params) ? '' : params)}`)
