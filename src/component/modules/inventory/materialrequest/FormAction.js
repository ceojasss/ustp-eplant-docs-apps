...
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    console.log('done fetch materialrequest')
...
export const fetchDatadetail = (params,callback) => async dispatch => {
    console.log('run fetch materialrequestdetail')

    const response = await eplant.get(`${ROUTES}/detail?mrcode=${params}`)

    console.log('done fetch materialrequestdetail')
