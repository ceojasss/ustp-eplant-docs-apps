...
const ROUTES = '/stores/Trx/returntostore'
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    //console.log('done fetch returntostore')
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    console.log('run fetch returntostoredetail')

    const response = await eplant.get(`${ROUTES}/detail?returnnotenumber=${params}`)

    console.log('done fetch returntostoredetail')
