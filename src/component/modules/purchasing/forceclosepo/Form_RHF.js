...
import { getFormListComponent, getFormComponent, useYupValidationResolver, InitValidationList, getFormTitle } from "../../../../utils/FormComponentsHelpler";
...
const Forms = ({ title, periode, units, actions, formComps, initialValues, postdata, formValidationSchema, resetTrx, submitdata, actionlabel }) => {
    ...
    const defaultDataValue = { pocode: units[0] }
    //  // console.log(initialValues)

    const methods = useForm({ mode: 'onblur', resolver, defaultValues: defaultDataValue && defaultDataValue })
