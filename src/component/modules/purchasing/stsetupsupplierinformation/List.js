/*=============================================================================
 ...
 |                - 
 |          
 |  Description:  List Setup Supplier Information
 |
 *===========================================================================*/
...
import { ActionHelpers, changeReducer, getTitle, IsInsert, LovDataSelected, PrepareEditData, QueryData, QueryReducerID, QuerySelectedData } from "../../../../utils/FormComponentsHelpler"
...
const List = ({ data, crudActions, selectedData, reducerid }) => {
    ...
    const rowClickHandler = async (action, row) => {
        ...
        switch (action) {
            ...
            case DELETE:
                ...
                let message = `Kode Data : ${row.original.suppliercode} Akan Dihapus`
    ...
    const column = _.filter(data[1], (o) => { return !_.isNull(o.tablecomponent) })
