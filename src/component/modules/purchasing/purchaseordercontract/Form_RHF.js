...
import { updateData, createData, executeApprove } from "./FormAction";
...
console.log(getValues('process_flag1'))
    if (actions) {
        ...
        switch (actions) {
            ...
            case Appresources.BUTTON_LABEL.LABEL_UPDATE:
                ...
                // console.log(submiting.data[0].header.process_flag1)
                if (submiting.data[0].header.process_flag1 === "APPROVED"){
                    // console.log('he')
                    dispatch(executeApprove(getValues('agreementcode')))
                }
