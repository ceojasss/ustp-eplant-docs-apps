...
import { setModalStates, setModalTrxStates } from '../../../../redux/actions'
import { ERROR_MODAL_STATE, EXCEPTION_ERROR, FETCH_DATAS, MODAL_STATE } from '../../../../redux/actions/types'
import { Appresources } from '../../../templates/ApplicationResources'

const ROUTES = '/purchasing/Trx/returnnotenongrn'

export const fetchDatas = () => async dispatch => {
    // console.log('run fetch returnnotenongrn')

    const response = await eplant.get(ROUTES)

    // console.log('done fetch returnnotenongrn')
