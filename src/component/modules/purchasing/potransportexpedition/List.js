/*=============================================================================
 ...
 |          
 |  Description:  List Transaksi PO Transport Expedition
 |
 *===========================================================================*/
     ...
     const rowClickHandler = async (action, row) => {
         ...
         switch (action) {
             case UPDATE:
                 ...
                 if (!isDataExist(row.original.documentcode))
                     await dispatch(fetchDatadetail(row.original.documentcode,
                         // async () => {
                 ...
                 navigate(`./edit/${encodeURIComponent(row.original.documentcode)}`)
                 break;
             case DELETE:
                 // * set custom delete message     
                 dispatch(DialogConfirmation(DELETE, `Kode Data : ${row.original.documentcode} Akan Dihapus`, row))
                 break;
             default:
                 break;
         }
