...
import { CHANGE_MODAL_ITEM_STATE, FETCH_LISTDATA, FETCH_LISTDATADETAIL, MODAL_STATE, RESET_DETAIL_DATA, SET_LOADING_STATUS, UPDATE_NAV } from '../../../../redux/actions/types'
import _ from 'lodash'
import format from 'dateformat'
import { errorResponse, insertResponse, updateResponse } from '../../../../redux/actions'
import { Appresources } from '../../../templates/ApplicationResources'

const ROUTES = "/emp/setup/parameterpayrollprocess";
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    console.log('done fetch parameterpayrollprocess')
...
export const fetchDatadetail = (params,callback) => async dispatch => {
    console.log('run fetch parameterpayrollprocessdetail')

    const response = await eplant.get(`${ROUTES}/detail?parametercode=${params}`)

    console.log('done fetch parameterpayrollprocessdetail')
