...
// console.log(initialValues)
            ...
            if (!_.isEmpty(submitdata)) {
                ...
                setTimeout(() => {
                    ...
                    if (_.isUndefined(initialValues['v_url_preview'])){
                        dispatch(fetchLovUrlPreview('MED',initialValues['process_flag'],initialValues['parametercode']))
                    }
                }, 0.1);
            } else {
    ...
    let buttonReport
    if (actionlabel == Appresources.BUTTON_LABEL.LABEL_UPDATE && ( !_.isEmpty(urlpreview) ? _.get(urlpreview[0],'v_url_preview').match('HR_MEDICAL_IZIN.rdf') :  _.includes(initialValues['v_url_preview'],'HR_MEDICAL_IZIN.rdf')) || ( !_.isEmpty(urlpreview) ? _.get(urlpreview[0],'v_url_preview').match('HR_MEDICAL_IZIN.RDF') :  _.includes(initialValues['v_url_preview'],'HR_MEDICAL_IZIN.RDF'))) {
        // console.log('1')
        buttonReport = [{
