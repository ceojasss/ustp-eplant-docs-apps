...
const ROUTES = '/emp/Trx/verifupkeep'
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    ...
    //// // console.log(params)
// console.log(params)
    const response = await eplant.get(`${ROUTES}/detail?gangcode=${(_.isUndefined(params[0]) ? '' : params[0])}&period=${format(params[1], 'dd/mm/yyyy')}`)
