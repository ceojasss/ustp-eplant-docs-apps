...
const ROUTES = '/contract/Trx/proformacontract'
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    console.log('run fetch proformacontractdetail')

    const response = await eplant.get(`${ROUTES}/detail?ppocode=${params}`)

    console.log('done fetch proformacontractdetail')
