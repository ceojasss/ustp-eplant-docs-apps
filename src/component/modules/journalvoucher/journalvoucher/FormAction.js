...
const ROUTES = '/journalvoucher/Trx/journalvoucher'
...
export const fetchDataheader = (pageIndex, pageSize, search, date, callback) => async dispatch => {
    ...
    //console.log('done fetch journalvoucher')
...
export const fetchDatadetail = (params, callback) => async dispatch => {
    console.log('run fetch journalvoucherdetail')

    const response = await eplant.get(`${ROUTES}/detail?jvno=${params}`)

    console.log('done fetch journalvoucherdetail')
