...
const Backdrop = styled.div`
  ...
  opacity: 0;
  transition: all 10ms cubic-bezier(0.4, 0, 0.2, 1);
...
export default function Modal(props) {
    ...
    React.useEffect(() => {
        ...
        //// console.log('render modal', open, locked, onClose)
        ...
        if (open) {
            window.setTimeout(() => {
                ...
                //?? document.activeElement.blur(); --> ini buat apa ya..? di remarks dulu soalnya kalo ada inputan jadi ngeblur inputannya setiap diketik
        ...
        return () => {
            ...
            //            // console.log('return close', current, open, locked, onClose)
