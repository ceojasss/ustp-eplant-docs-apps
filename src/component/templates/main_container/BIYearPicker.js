...
function BIYearPicker({ pickedDateAction, pickedDate }) {
  ...
  return (
    ...
    <Input size='mini' >
      ...
      <ReactDatePicker
        ...
        customInput={
          <InputMask mask="9999" style={{ textAlign: 'center', width: '9vw' }} />
        }
      />
    </Input>
  );
...
export default connect(mapStateToProps)(BIYearPicker);
